...
const displays: {
  [key in RoundButtonDisplay]: { textColor: string; backgroundColor: string; borderColor: string };
} = {
  default: { backgroundColor: '#fff', borderColor: '#fff', textColor: 'black' },
  inverted: { backgroundColor: 'transparent', borderColor: 'transparent', textColor: Theme.text },
};
...
export const RoundButton = React.memo((props: RoundButtonProps) => {
