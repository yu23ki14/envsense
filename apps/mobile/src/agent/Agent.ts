...
export class Agent {
  ...
  // Invoked from a component's render (DeviceView) as a custom hook. The hook
  // call order is stable; biome cannot see the class-method-as-hook pattern.
  use() {
    // biome-ignore lint/correctness/useHookAtTopLevel: called from component render
